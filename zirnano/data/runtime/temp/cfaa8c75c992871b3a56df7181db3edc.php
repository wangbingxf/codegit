<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/view_article.htm";i:1691138103;s:36:"E:\APMZ\web12\template\pc\header.htm";i:1691069279;s:36:"E:\APMZ\web12\template\pc\footer.htm";i:1691068475;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8" />
...
<link href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/css/yyly_details.css" rel="stylesheet" type="text/css" />
<meta name='viewport' content='width=1440' />
<meta http-equiv="Cache-Control" content="no-transform" />
...
<body data-pageid="5c8260b4-58d6-4fcc-b107-a83bc7e471d4" data-layout="flow" data-tmplid="fe7d153b-602f-457a-9181-2b1b671cf38f">
...
</div><div id="w_grid-1577071578786" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1577071578786-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1579414453868" class="w_grid-000" data-tmpleditable="editable"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579414453868-0" class="e_box e_box-000 d_gridCell_0 p_gridCell ND_empty" data-editablecontent="1579414453868"><div id="c_portalResEbizads_banner-1613974934102" class="c_portalResEbizads_banner-01001"> 
...
</div><div id="w_grid-1613974934052" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1613974934052-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"></div>       </div>  </div></div><div id="w_grid-1615427127691" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1615427127691-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1615427135189" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1615427135189-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResNews_category-16154271372553278" class="c_portalResNews_category-01001"> 
<div class="NavList_a1">
	<ul class="clearfix">
		...
		<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>	
...
</div></div>       </div>  </div></div></div>       </div>  </div></div><div id="w_grid-1613974934062" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1613974934062-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1613974934072" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1613974934072-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResNews_detail-1613974934117" class="c_portalResNews_detail-01001"> 
                <div class="e_box p_NewsDetail" data-ename="资讯详情" data-infoid="23">
            <div class="e_box p_topBox">
                ...
                <ul class="e_box p_dataSource borderT_default" data-ename="资讯信息">
					<li class="sort"><span class="i_sort"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:8:"classify";}'); echo $__VALUE__; ?>：</span><a href="<?php echo $eyou['field']['typeurl']; ?>"><?php echo $eyou['field']['typename']; ?> </a></li>
                    <li class="auth"><span class="i_auth"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"uthor";}'); echo $__VALUE__; ?>：</span><?php echo $eyou['field']['author']; ?></li>
                    <li class="source"><span class="i_source"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:6:"source";}'); echo $__VALUE__; ?>：</span><?php echo $eyou['field']['origin']; ?></li>
                    <li class="date"><span class="i_pubDate"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:4:"time";}'); echo $__VALUE__; ?>：</span><?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?> </li>
					<li class="date"><span class="i_pubDate">发布时间：</span><?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?> </li>
                </ul>
                <p class="e_article p_summary background_info" data-ename="资讯概要信息">
                    <span><span class="i_SummaryBox">【概要描述】</span></span>
                </p>
            </div>
			<?php if(!(empty($eyou['field']['image_list']) || (($eyou['field']['image_list'] instanceof \think\Collection || $eyou['field']['image_list'] instanceof \think\Paginator ) && $eyou['field']['image_list']->isEmpty()))): ?>
            <div class="e_box p_imgsBox borderB_default" >
                <div class="swiper-container gallery-top">
                    <div class="swiper-wrapper"> 
								 ...
								 <div data-foreachitem class="swiper-slide">
                                    	 <img src="<?php echo $field['image_url']; ?>" class='js_thumb' title='<?php echo $field['intro']; ?>' alt='news' />
                                    <div class="e_box p_SummaryBox background_shade">
                                        <div class="e_box p_textBoxs color_horizon">
                                            <h4 class="e_title p_ImgHead color_horizon" data-ename="图片标题"><?php echo $field['intro']; ?></h4>
                                            <p class="e_article p_ImgSummary color_horizon" data-ename="图片描述"><?php echo $field['intro']; ?></p>
                                        </div>
                                    </div>
                                </div> 
                ...
                <div class="swiper-container gallery-thumbs">
                    <div class="swiper-wrapper">
                                ...
                                </div><?php echo isset($field["ey_1563185380"])?$field["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($field["ey_1563185376"]))?$field["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
                    </div>
            ...
            <div class="e_box p_articles" data-ename="资讯详细描述"><?php echo $eyou['field']['content']; ?></div>
            ...
            <div class="e_box d_pcDom p_PrevAndNext borderB_default" data-ename="上一篇、下一篇信息区">
                                                <div class="e_box p_previewBox"> <?php  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("pre");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; $field["title"] = text_msubstr($field["title"], 0, 100, false); ?>
									<a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>">   <?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys11";}'); echo $__VALUE__; ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo html_msubstr($field['title'],0,16); ?></a>  
									<?php else:  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys11";}'); echo $__VALUE__; ?>：<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys10";}'); echo $__VALUE__; endif; $field = []; ?> </div>
                                                <div class="e_box p_nextBox"><?php  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("next");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; $field["title"] = text_msubstr($field["title"], 0, 100, false); ?>
								<a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys12";}'); echo $__VALUE__; ?>&nbsp;&nbsp;|&nbsp;&nbsp;：<?php echo html_msubstr($field['title'],0,16); ?></a>  
								<?php else:  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys12";}'); echo $__VALUE__; ?>：<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys10";}'); echo $__VALUE__; endif; $field = []; ?>  </div>
            </div>
        ...
        $comp({
            ...
            id: "portalResNews_detail-1613974934117",//实例id 服务器传
            lib: ["js/portalNews/portalResNews_detail-01"], //组件js
            noDataFlag:""
        });
    </script>
<script>$("div[id^='c_']").attr("loaded","true")</script>
</div><div id="w_grid-1613974934082" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1613974934082-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"></div>       </div>  </div></div></div>       </div>  </div></div><div id="w_grid-1613974934092" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1613974934092-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"></div>       </div>  </div></div></div>       </div>  </div></div></div>       </div>  </div></div></div>       </div>  </div></div>
