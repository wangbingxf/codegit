<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"./template/pc/lists_article_job.htm";i:1691152259;s:36:"E:\APMZ\web12\template\pc\header.htm";i:1691069279;s:36:"E:\APMZ\web12\template\pc\footer.htm";i:1691068475;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8" />
...
<link href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/css/zxns.css" rel="stylesheet" type="text/css" />
<meta name='viewport' content='width=1440' />
<meta http-equiv="Cache-Control" content="no-transform" />
...
<body data-pageid="aa8df209-40e9-4276-9068-1823928b6300" data-layout="flow" data-tmplid="fe7d153b-602f-457a-9181-2b1b671cf38f">
...
</div><div id="w_grid-1577071578786" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1577071578786-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1579414453868" class="w_grid-000" data-tmpleditable="editable"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579414453868-0" class="e_box e_box-000 d_gridCell_0 p_gridCell ND_empty" data-editablecontent="1579414453868"><div id="w_grid-1604931076502" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604931076502-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResEbizads_banner-1604931076702" class="c_portalResEbizads_banner-01001"> 
...
</div></div>       </div>  </div></div><div id="w_grid-1604931076512" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604931076512-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1604931076522" class="w_grid-001"><div class="w_grid ">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604931076522-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1604931076532" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604931076532-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1604931076542" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604931076542-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"></div>       </div>  </div></div></div>       </div>  </div></div><div id="c_portalResIntro_category-1604931076707" class="c_portalResIntro_category-01001001"> 
...
</div></div>         <div id="content_box-1604931076522-1" class="e_box e_box-000 d_gridCell_1 p_gridCell"><div id="c_portalResBreadcrumb_nav-1604931076712" class="c_portalResBreadcrumb_nav-01001"> <!--homePage  首页-->
...
</div></div>       </div>  </div></div></div>       </div>  </div></div><div id="w_grid-1604931076552" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604931076552-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1604931076562" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604931076562-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_common_text-1604931076672" class="reset_style"><div><p style="text-align:center"><span style="line-height:1.6"><span style="color:#000"><strong><span style="font-size:26px"><?php echo $eyou['field']['typename']; ?> </span></strong></span></span></p>
</div></div><div id="w_common_text-1604931076677" class="reset_style"><div><p><span style="font-size:16px"><span style="line-height:1.8"><?php echo $eyou['field']['seo_description']; ?></span></span></p>
</div></div></div>       </div>  </div></div><div id="c_portalResEmploy_list-16148589581353313" class="c_portalResEmploy_list-01001006"> 
    ...
    <div class="job-box">
        <div class="container">
			...
			<div class="recruit-tit">    
				<div class="rta rta1"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:12:"positionname";}'); echo $__VALUE__; ?></div>
				<div class="rta rta2"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:9:"education";}'); echo $__VALUE__; ?></div>
				<div class="rta rta3"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:17:"recruitingnumbers";}'); echo $__VALUE__; ?></div>
				<div class="rta rta4"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:4:"time";}'); echo $__VALUE__; ?></div>
			</div>
            <div class="p_content job-lists">
                <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "",      "keyword"=> "",      "idlist"=> "",      "idrange"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 10, "", "content", "desc", "on","off","");if(!empty($_result_tmp) && (is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 40, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>					
				<div class="job-list">
                    <div class="top-content">
                      <div class="topclick">
                        <span class="job-name"><?php echo $field['title']; ?></span>
                        <span class="job-education"><?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("xueli", $aid); echo $__VALUE__; unset($aid); ?></span>
                        <span class="job-peple"> <?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("renshu", $aid); echo $__VALUE__; unset($aid); ?></span>
                        <span class="job-time"><?php echo MyDate('Y-m-d',$field['add_time']); ?></span>
                        <span class="job-iocn">
                            <i class="iconfont">&#xe633;</i>
                        </span>
                        </div>
                    ...
                    <div class="bottom-content">
                        <div class="content-top">
							<?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("jieshao", $aid); echo $__VALUE__; unset($aid); ?>
                        </div>
                      
                        <div class="content-bottom">
                            <article class="job-summry"><?php echo $field['content']; ?></article>
                        </div>
                    </div>
                </div>
