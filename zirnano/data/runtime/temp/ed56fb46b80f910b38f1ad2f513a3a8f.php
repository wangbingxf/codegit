<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:23:"./template/pc/index.htm";i:1691069293;s:36:"E:\APMZ\web12\template\pc\header.htm";i:1691069279;s:36:"E:\APMZ\web12\template\pc\footer.htm";i:1691068475;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8" />
...
<body data-pageid="be790d2c-ff86-440e-bb2d-7ef5694552b8" data-layout="flow">
	<div class="main pagebox"><div id="w_grid-1577071265817" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">        
	<div id="content_box-1577071265817-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1577081423563" class="w_grid-000"><div class="w_grid signal">  
	<div class="e_box e_box-000 p_gridbox">         
	<div id="content_box-1577081423563-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResnav_main-15997884350933345" class="c_portalResnav_main-01001014"> 
...
<div id="w_grid-1599796264864" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1599796264864-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResEbizads_banner-15998094117454302" class="c_portalResEbizads_banner-01001018"> 
	...
	<div class="swiper-container">
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<div class="pcimg">
				 <img class="bannerPic" src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>">
				</div>
				<div class="moimg">
				 <img class="bannerPic" src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>">
				</div>
				<div class="ind_ban_tex">
				<div class="ind_ban_tex_title_en"><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_3"); echo $__VALUE__; ?></div>
				<div class="b_line"></div>
				<div class="ind_ban_con">    
					  <div class="ind_ban_tex_title"><h1 class="t_big"><?php echo $field['title']; ?></h1></div>
					  <div class="ind_ban_tex_info"><p class="t_small"><?php echo $field['intro']; ?></p></div>
				</div>
				</div>
			</div>
			<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
...
<div id="w_grid-1599786937890" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1599786937890-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1599787378164" class="w_grid-001"><div class="w_grid ">   <div class="e_box e_box-000 p_gridbox">        

<?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "2"; endif; if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 5; endif; $tagChannelartlist = new \think\template\taglib\eyou\TagChannelartlist; $_result = $tagChannelartlist->getChannelartlist($typeid, "son",""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$channelartlist): $channelartlist["typename"] = text_msubstr($channelartlist["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $channelartlist;$i= intval($key) + 1;$mod = ($i % 2 ); ?> 
<div id="content_box-1599787378164-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1599787378174" class="w_grid-001"><div class="w_grid ">   <div class="e_box e_box-000 p_gridbox">    <div id="content_box-1599787378174-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_fimg-1599787378188" class="w_fimg-000"><div class="w_img animated  ">  <div class="e_box e_box-000 p_box">   <a href="<?php  $__VALUE__ = isset($channelartlist["typeurl"]) ? $channelartlist["typeurl"] : "变量名不存在"; echo $__VALUE__; ?>" class="e_link e_link-000 p_link001" target="_self">            <div class="e_image e_DImage-001 p_dimage">            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/ic<?php echo $i; ?>.png" alt="<?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?>" width="100%" height="100%" />           </div>             </a>           </div> </div></div></div>
	<div id="content_box-1599787378174-1" class="e_box e_box-000 d_gridCell_1 p_gridCell"><div id="w_common_text-1599787378197" class="reset_style"><div><p style="text-align:center"><a href="<?php  $__VALUE__ = isset($channelartlist["typeurl"]) ? $channelartlist["typeurl"] : "变量名不存在"; echo $__VALUE__; ?>"><span style="color:#FFFFFF"><strong><span style="font-size:20px"><?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?></span></strong></span></a></p>
	</div></div><div id="w_common_text-1599787378201" class="reset_style"><div><p style="text-align:center"><a href="/news/8/"><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><span style="line-height:1.6"><span style="color:#FFFFFF"><?php  $__VALUE__ = isset($channelartlist["englist_name"]) ? $channelartlist["englist_name"] : "变量名不存在"; echo $__VALUE__; ?> </span></span></span></span></a></p>
	</div></div></div>    
</div>  </div></div></div>        
...
<div id="w_grid-1598506988431" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1598506988431-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1598507448418" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1598507448418-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_common_text-1598507448434" class="reset_style"><div><h1 style="text-align:center"><span style="color:#16479e"><span style="font-size:36px"><?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?></span></span></h1>
</div></div><div id="w_fline-1598507448440" class="w_fline-001"><div class="w_fline">  <div class="e_line e_Hline-001 p_FLine"></div> </div></div><div id="w_common_text-1598507448448" class="reset_style"><div><p style="text-align:center"><span style="letter-spacing:0px"><span style="font-size:18px"><?php  $__VALUE__ = isset($channelartlist["englist_name"]) ? $channelartlist["englist_name"] : "变量名不存在"; echo $__VALUE__; ?></span></span></p>
</div></div><div id="w_grid-1601294582117" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1601294582117-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResProduct_category-16012945806490263" class="c_portalResProduct_category-01001"> 
<link rel="stylesheet" href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/css/rbqbhv0t2rcebalnaaaaabwsxic584.css">
<div class="proCateDemo">
    <div class="swiper-container wyz-cate-container c_portalResProduct_category-16012945806490263_swiper">
        <div class="swiper-wrapper">
            <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 60; endif; $tagChannel = new \think\template\taglib\eyou\TagChannel; $_result = $tagChannel->getChannel($typeid, "son", "", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $field["typename"] = text_msubstr($field["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $field;$i= intval($key) + 1;$mod = ($i % 2 ); ?>
			<div class="p_articlesC swiper-slide">
                <!-- 标题 -->
                <a href="<?php echo $field['typeurl']; ?>" class="p_infoA title"><?php echo $field['typename']; ?></a>
            </div>
			<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
        </div>
    </div>
    <!-- 切换按钮 -->
    <div class="swiper-button btn-prev c_portalResProduct_category-16012945806490263_prev ">
        <i class="iconfont">&#xe6b0;</i>
    </div>
    <div class="swiper-button btn-next c_portalResProduct_category-16012945806490263_next">
        <i class="iconfont">&#xe6af;</i>
    </div>
</div>
<script>
    $(document).ready(function () {
        // 获取组件实例
        var id = "portalResProduct_category-16012945806490263"  // 组件ID
        var scp = $compCl.getScope(id)  // 组件实例
        var pathname = window.location.pathname;
        // swiper4.0
        require(["swiper4.4.2"], function (med) {
            var wyzCate = new Swiper('.c_portalResProduct_category-16012945806490263_swiper', {
                ...
                // 前进后退按钮
                navigation: {
                    nextEl: '.c_portalResProduct_category-16012945806490263_next ',
                    prevEl: '.c_portalResProduct_category-16012945806490263_prev  ',
...
</div></div>       </div>  </div></div></div>       </div>  </div></div><div id="c_portalResProduct_list-15985074033263728" class="c_portalResProduct_list-01001001"> 
 ...
 <!-- 内容部分开始 -->
  ...
  'titlelen' => '25',
					...
					<li class="productLi swiper-slide">
                        <a href="<?php echo $field['arcurl']; ?>" class="block relative aTop">
                            <div class="absolute picture">
								<img src="<?php echo $field['litpic']; ?>" title='<?php echo $field['title']; ?>' class='proPic' alt='<?php echo $field['title']; ?>' />
	                        </div>
                            <div class="blue absolute trans5">
                                <div class="number relative"><?php echo $field['title']; ?></div>
                                <div class="desc1"><?php echo html_msubstr($field['seo_description'],0,50,true); ?></div>
                            </div>
                        </a>
                        <div class="text-center">
                            <a href="<?php echo $field['arcurl']; ?>" class="proName2"><?php echo $field['title']; ?></a>                         
                        </div>
                    </li>
...
<div id="w_fbtn-1598513650815" class="w_fbtn-001"><div class="w_fbtn animated  ">  <a href="<?php  $__VALUE__ = isset($channelartlist["typeurl"]) ? $channelartlist["typeurl"] : "变量名不存在"; echo $__VALUE__; ?>" class="e_link e_link-001 p_link" target="_self" title="MORE +">   <div class="e_btn e_CommonBtn-001 p_CommonBtn">    <div class="font">MORE +</div>   </div>  </a> </div></div></div>       </div>  </div></div>
<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $typeid = $row = ""; unset($channelartlist); ?> 

<div id="c_portalResPublic_codeContainer-15998111119305244" class="c_portalResPublic_codeContainer-01001" data-vhide768="true"> 
<div class="e_box"></div>
<div class="m2_wrapper">
  <ul class="sfq hidden-xs">
    <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "57"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 6; endif; $modelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $modelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off",      "idlist"=> "",      "idrange"=> "",      "aid"=> "", ); $tag = array (
  'row' => '6',
  'titlelen' => '25',
  'addfields' => 'content',
  'orderby' => 'aid',
  'orderway' => 'asc',
  'typeid' => '57',
); $tagArclist = new \think\template\taglib\eyou\TagArclist; $_result = $tagArclist->getArclist($param, $row, "aid", "content","asc","",$tag,"0","on","off","","");if(!empty($_result["list"]) && (is_array($_result["list"]) || $_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = is_array($_result["list"]) ? array_slice($_result["list"],0, $row, true) : $_result["list"]->slice(0, $row, true);  $__TAG__ = $_result["tag"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 25, false);if($field["is_b"] == 1) : $field["title"] = "<strong>".$field["title"]."</strong>";endif;$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>									
	<li class="<?php if($i == '1'): ?>on<?php endif; ?>">
      <img src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" style="width:900px;">
      <div class="txt">
        ...
        <div class="jj1"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/ss<?php echo $i; ?>.png" alt="<?php echo $field['title']; ?>"></div>
      </div>
      <div class="title">
        <div class="jj2"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/ss<?php echo $i; ?>.png" alt="<?php echo $field['title']; ?>"></div>
...
<script>
$(".m2_wrapper li").hover(function () {
  $(this).addClass("on").siblings().removeClass("on");
})
</script></div><div id="w_grid-1599811056106" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1599811056106-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"></div>       </div>  </div></div>
 <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "3"; endif; if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 10; endif; $tagChannelartlist = new \think\template\taglib\eyou\TagChannelartlist; $_result = $tagChannelartlist->getChannelartlist($typeid, "self",""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$channelartlist): $channelartlist["typename"] = text_msubstr($channelartlist["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $channelartlist;$i= intval($key) + 1;$mod = ($i % 2 ); ?> 
<div id="w_grid-1598511335039" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1598511335039-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1598514667452" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1598514667452-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_common_text-1598514667470" class="reset_style"><div><h1 style="text-align:center"><span style="color:#16479e"><span style="font-size:36px"><?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?></span></span></h1>
</div></div><div id="w_fline-1598514667477" class="w_fline-001"><div class="w_fline">  <div class="e_line e_Hline-001 p_FLine"></div> </div></div><div id="w_common_text-1598514667487" class="reset_style"><div data-url="#"><p style="text-align:center"><span style="letter-spacing:0px"><span style="font-size:18px"><?php  $__VALUE__ = isset($channelartlist["englist_name"]) ? $channelartlist["englist_name"] : "变量名不存在"; echo $__VALUE__; ?></span></span></p>
</div></div></div>       </div>  </div></div><div id="w_fimg-1598516032705" class="w_fimg-000"><div class="w_img animated  ">  <div class="e_box e_box-000 p_box"> 
...
<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $typeid = $row = ""; unset($channelartlist);  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "7"; endif; if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 10; endif; $tagChannelartlist = new \think\template\taglib\eyou\TagChannelartlist; $_result = $tagChannelartlist->getChannelartlist($typeid, "self",""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$channelartlist): $channelartlist["typename"] = text_msubstr($channelartlist["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $channelartlist;$i= intval($key) + 1;$mod = ($i % 2 ); ?> 
<div id="w_grid-1599920205589" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1599920205589-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1599920205612" class="w_grid-001"><div class="w_grid ">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1599920205612-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_fimg-1599920205622" class="w_fimg-000" data-animation="once"><div class="w_img animated  ">  <div class="e_box e_box-000 p_box">   
	<a class="e_link e_link-000 p_link001" target="_self" disabled="disabled" href="<?php  $__VALUE__ = isset($channelartlist["typeurl"]) ? $channelartlist["typeurl"] : "变量名不存在"; echo $__VALUE__; ?>">            <div class="e_image e_DImage-001 p_dimage">            <img src="<?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", "sytp"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?><?php echo $field['sytp']; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>" alt="<?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?>" title="<?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?>" width="100%" height="100%" />           </div>             </a>     
</div> </div></div></div>         

<div id="content_box-1599920205612-1" class="e_box e_box-000 d_gridCell_1 p_gridCell"><div id="w_grid-1599920205630" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1599920205630-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_common_text-1599920205638" class="reset_style" data-vhide414="true"><div><p><span style="color:#16479e"><span style="font-size:60px"><strong><?php  $__VALUE__ = isset($channelartlist["englist_name"]) ? $channelartlist["englist_name"] : "变量名不存在"; echo $__VALUE__; ?></strong></span></span></p>
</div></div><div id="w_common_text-1599920205643" class="reset_style"><div><p><span style="font-size:30px"><strong><?php  $__VALUE__ = isset($channelartlist["typename"]) ? $channelartlist["typename"] : "变量名不存在"; echo $__VALUE__; ?></strong></span></p>
</div></div><div id="w_fline-1599920205648" class="w_fline-001" data-animation="once"><div class="w_fline">  <div class="e_line e_Hline-001 p_FLine"></div> </div></div><div id="w_common_text-1599920205653" class="reset_style"><div>
<p><?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", "synr"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?><?php echo $field['synr']; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
</div><div id="w_grid-1599920205658" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1599920205658-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResPublic_codeContainer-15999202053336859" class="c_portalResPublic_codeContainer-01001"> 
<div class="e_box"></div>


<div class="about-num">
	<ul class="f-cb">
		<?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", "canshu"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?>   <?php echo htmlspecialchars_decode($field['canshu']); endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
	</ul>
</div>

</div><div id="w_fbtn-1600077666738" class="w_fbtn-001"><div class="w_fbtn animated  ">  <a href="<?php  $__VALUE__ = isset($channelartlist["typeurl"]) ? $channelartlist["typeurl"] : "变量名不存在"; echo $__VALUE__; ?>" class="e_link e_link-001 p_link" target="_self" title="MORE +">   <div class="e_btn e_CommonBtn-001 p_CommonBtn">    <div class="font">MORE +</div>   </div>  </a> </div></div></div>       </div>  </div></div></div>       </div>  </div></div></div>       </div>  </div></div></div>       </div>  </div></div></div>       </div>  </div></div>
<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $typeid = $row = ""; unset($channelartlist); ?>
