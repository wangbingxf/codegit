<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"./template/pc/lists_article.htm";i:1691116716;s:36:"E:\APMZ\web12\template\pc\header.htm";i:1691069279;s:36:"E:\APMZ\web12\template\pc\footer.htm";i:1691068475;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8" />
...
<link href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/css/news_lsit.css" rel="stylesheet" type="text/css" />
<meta name='viewport' content='width=1440' />
<meta http-equiv="Cache-Control" content="no-transform" />
...
<body data-pageid="41a995e1-0683-4314-8b1c-8cd5e73a36e7" data-layout="flow" data-tmplid="fe7d153b-602f-457a-9181-2b1b671cf38f">
	<div class="main pagebox">
	<div id="c_portalResnav_main-16048453281381729" class="c_portalResnav_main-01001014"> 
...
<div id="w_grid-1577071578786" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1577071578786-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1579414453868" class="w_grid-000" data-tmpleditable="editable"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579414453868-0" class="e_box e_box-000 d_gridCell_0 p_gridCell ND_empty" data-editablecontent="1579414453868"><div id="c_portalResEbizads_banner-16049250621366746" class="c_portalResEbizads_banner-01001"> 
...
</div><div id="w_grid-1579422434307" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579422434307-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1579422454184" class="w_grid-001"><div class="w_grid ">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579422454184-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResNews_category-15794225522659146" class="c_portalResNews_category-01001"> 
...
</div></div>         <div id="content_box-1579422454184-1" class="e_box e_box-000 d_gridCell_1 p_gridCell"><div id="c_portalResBreadcrumb_nav-15794225717728050" class="c_portalResBreadcrumb_nav-01001"> <!--homePage  首页-->
...
</div></div>       </div>  </div></div></div>       </div>  </div></div><div id="w_grid-1604925063623" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1604925063623-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"></div>       </div>  </div></div><div id="w_grid-1579422823626" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579422823626-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1579422841500" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579422841500-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResNews_list-15794228417631318" class="c_portalResNews_list-01001"> 
<div>
        <div class="newListBox">
            <div class="p_news">
				...
				<div class="newList">
                    <div class="content">
                        <div class="leftTime">
                            <span class="newTime"><?php echo MyDate('m-d',$field['add_time']); ?></span>
                            <i class="iconfont newIcon">&#xe6a7;</i>
                        </div>
                        <div class="rightC">
                            <h3 class="newTitle">
                                <a href="<?php echo $field['arcurl']; ?>" target="_self" class="newTitleLink"> <?php echo $field['title']; ?></a>
                            </h3>
                            <article class="newMs">  <?php echo html_msubstr($field['seo_description'],0,100,true); ?></article>
                        </div>
                    </div>
                    <div class="newPicBox">
                        <a href="<?php echo $field['arcurl']; ?>" target="_self" class="newPicLink">
                        	 <img src="<?php echo $field['litpic']; ?>" title='<?php echo $field['title']; ?>' class='newPic' alt='<?php echo $field['title']; ?>' />
	                    </a>
                    </div>
                </div>
