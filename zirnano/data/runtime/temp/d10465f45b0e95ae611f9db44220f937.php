<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/lists_images.htm";i:1691070895;s:36:"E:\APMZ\web12\template\pc\header.htm";i:1691069279;s:36:"E:\APMZ\web12\template\pc\footer.htm";i:1691068475;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8" />
...
<link href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/css/yyly.css" rel="stylesheet" type="text/css" />
<meta name='viewport' content='width=1440' />
<meta http-equiv="Cache-Control" content="no-transform" />
...
<div id="w_grid-1577071578786" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1577071578786-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1579414453868" class="w_grid-000" data-tmpleditable="editable"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1579414453868-0" class="e_box e_box-000 d_gridCell_0 p_gridCell ND_empty" data-editablecontent="1579414453868"><div id="w_grid-1611302982675" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1611302982675-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResEbizads_banner-1611302982745" class="c_portalResEbizads_banner-01001"> 
...
<input type="hidden" class="requsetParam" value="&pid=0&compId=portalResEbizads_banner-1611302982745" />
<input type="hidden" class="requsetID" data-ename="可视化配置" value="&columnId=1" />
</div></div>       </div>  </div></div><div id="w_grid-1611302982685" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1611302982685-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1611302982695" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1611302982695-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="c_portalResNews_category-16154262724036226" class="c_portalResNews_category-01001"> 
...
</div></div>       </div>  </div></div></div>       </div>  </div></div><div id="w_grid-1611302982725" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1611302982725-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1611302982735" class="w_grid-001"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1611302982735-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"><div id="w_grid-1613974692120" class="w_grid-000"><div class="w_grid signal">   <div class="e_box e_box-000 p_gridbox">         <div id="content_box-1613974692120-0" class="e_box e_box-000 d_gridCell_0 p_gridCell"></div>       </div>  </div></div><div id="c_portalResNews_list-16139746823069744" class="c_portalResNews_list-01001"> 
<div>
<div class="newBox">
    <div class="newUl  p_news newContainer">
        <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "",      "keyword"=> "",      "idlist"=> "",      "idrange"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 12, "", "", "desc", "on","off","");if(!empty($_result_tmp) && (is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 40, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>					
		<div class="p_articles newLi">
            <div class="porTbox">
                	 <img src="<?php echo $field['litpic']; ?>" lazy-src="<?php echo $field['litpic']; ?>" title='<?php echo $field['title']; ?>' class='js_thumb newImg'
                alt='<?php echo $field['title']; ?>' />
	                <div class="showBox">
                    <a href="<?php echo $field['arcurl']; ?>" target="_self" class="showBoxLink"><?php echo $field['title']; ?></a>
                </div>
            </div>
            <div class="porBbox">
                <div class="leftBox">
                    <div class="p_title newTitle"><?php echo $field['title']; ?></div>
                </div>
            </div>
        </div>
