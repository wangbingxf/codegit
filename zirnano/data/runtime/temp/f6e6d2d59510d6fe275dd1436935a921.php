<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:46:"./application/admin/template/product\index.htm";i:1655708908;s:58:"E:\APMZ\web12\application\admin\template\public\layout.htm";i:1686877574;s:61:"E:\APMZ\web12\application\admin\template\public\theme_css.htm";i:1680508820;s:62:"E:\APMZ\web12\application\admin\template\archives\tags_btn.htm";i:1686877574;s:62:"E:\APMZ\web12\application\admin\template\archives\flag_btn.htm";i:1680508820;s:56:"E:\APMZ\web12\application\admin\template\public\page.htm";i:1655708909;s:58:"E:\APMZ\web12\application\admin\template\public\footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table style="width: 100%;">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td>
                                <div class="w120 tc ellipsis">
                                    <a href="<?php echo url('Product/index', array('typeid'=>$vo['typeid'], 'tab'=>3)); ?>" title="<?php echo $vo['typename']; ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a>
                                </div>
                            </td>
                            <td class="">
                                <div class="tc w50">
                            ...
                            <td class="operation">
                                <div class="w160 tc">
                                    ...
                                    <a href="<?php echo url('Product/edit',array('id'=>$vo['aid'])); ?>" class="btn blue">编辑</a>
                                    <i></i>
                                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Product/del'); ?>" data-id="<?php echo $vo['aid']; ?>" <?php if($recycle_switch == '1'): ?> data-deltype="del" <?php else: ?> data-deltype="pseudo" <?php endif; ?> onClick="delfun(this);">删除</a>
                                    <i></i>
                                    <?php endif; ?>
        ...
        <div class="footer-oper">
            ...
            <div class="nav-dropup">
                ...
                <div class="dropdown-menus" style="display:none; <?php if(0 < $pager->totalRows && ($pager->totalRows < 3 || $pager->listRows < 3)): ?>top:28px;bottom:unset;border-bottom:1px solid rgba(0,0,0,.15);border-top:none;min-height: 250px;<?php endif; ?>">
                    ...
                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                    <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Product/del'); ?>" <?php if($recycle_switch == '1'): ?> data-deltype="del" <?php else: ?> data-deltype="pseudo" <?php endif; ?>>删除文档</a>
